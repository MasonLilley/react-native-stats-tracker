...
const ChooseExerciseButtons = ({ onLeft1ButtonPress, onLeft2ButtonPress, onRight1ButtonPress, onRight2ButtonPress, title }) => (
...
const styles = StyleSheet.create({
  container: {
    ...
    width: '100%',
    paddingHorizontal: 16, // Adjust the padding to suit your needs
  },
  leftContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    marginLeft: '-3%', //adjust
    marginRight: '1%' //adjust
  },
  centerContainer: {
    flex: 1,
    alignItems: 'center',
...
export default ChooseExerciseButtons;
